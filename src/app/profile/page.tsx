      ...
      <div className="mx-auto max-w-5xl px-4 py-8 md:px-6">
        <section className="glass-panel mb-8 rounded-[2rem] p-6">
          <div className="flex items-center gap-4">
            {session.user.image ? (
              <Image src={session.user.image} alt={session.user.name || 'Profile'} width={72} height={72} unoptimized className="rounded-3xl" />
            ) : (
            ...
            <div>
              ...
              <h1 className="mt-1 text-3xl font-black tracking-tight">{session.user.name || 'Anonymous User'}</h1>
